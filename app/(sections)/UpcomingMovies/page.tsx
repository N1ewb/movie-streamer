...
import { getMoviesByPopular, getUpcomingMovies } from "@/lib/global";
...
const UpcomingMovies = () => {
  ...
  const handleGetUpcomingMovies = async (page: number) => {
    try {
  ...
  return (
    <div className=" movies-list-container p-[45px] max-w-full text-white z-20">
      <div className="movies-list-header">
        <h1 className="font-semibold text-3xl">Upcoming Movies</h1>
      </div>
      <div className=" upcoming-movies-content-container flex flex-row items-center justify-between p-[30px] w-full">
        <button
